...
export default function MonthSidebar({
  ...
  return (
    <aside className="hidden lg:flex w-full lg:w-90 bg-surface border border-border shadow-[0_8px_24px_rgba(84,70,58,0.04)] rounded-card p-6 flex-col gap-6 lg:sticky lg:top-24 shrink-0">
      ...
      <div className="flex flex-col gap-3 w-full">
        {contentList.length === 0 ? (
          ...
          contentList.map((item, index) => {
            ...
            const rowInner = (
              <div
                className={`flex flex-row items-center justify-between p-4 w-full min-h-14.5 ${isLocked ? "opacity-70" : ""}`}
              >
                <div
