  ...
  return (
    <section className="flex flex-col gap-4 w-full pb-12">
      <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4 w-full">
        <h2 className="font-extrabold text-[20px] text-text-main flex-1 min-w-0 wrap-break-word">
            ...
            >
              <div className="flex items-start sm:items-center gap-3 w-full lg:w-auto flex-1 min-w-0">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4 flex-1 min-w-0">
                  <h3 className="font-semibold text-[15px] text-text-main wrap-break-word">
                    {item.title}
                  </h3>
                  <span
