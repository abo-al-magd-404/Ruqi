...
export default function LogoutConfirmModal({
  ...
  return (
    ...
    >
      <div
        className="w-full sm:max-w-110 bg-surface rounded-t-[20px] sm:rounded-b-[20px] border border-border p-6 md:p-8 shadow-2xl"
        dir="rtl"
        onClick={(e) => e.stopPropagation()}
      >
        <h3 className="text-[20px] font-extrabold text-text-main mb-3 text-center">
          تسجيل الخروج
        </h3>
        ...
        <div className="flex gap-3">
          ...
          <button
            ...
            onClick={onConfirm}
            disabled={loggingOut}
            className="flex-1 h-12 bg-danger text-white font-bold text-[14px] rounded-xl hover:bg-danger-hover transition-colors disabled:opacity-60"
          >
