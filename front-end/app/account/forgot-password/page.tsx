...
import { forgetPassword } from "@/lib/account/auth";
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background px-4 relative overflow-hidden font-cairo py-12 md:py-20">
      ...
      <form
        ...
        className="relative z-10 w-full max-w-130 bg-surface rounded-[20px] md:rounded-3xl border border-border shadow-[0_16px_48px_-4px_rgba(84,70,58,0.0588)] p-6 sm:p-8 md:p-12 transition-all"
        dir="rtl"
      >
        ...
        <div className="flex flex-col items-center gap-5 mt-2">
          <button
            type="submit"
            disabled={loading}
            className="w-full h-13 md:h-14.5 bg-primary rounded-xl text-text-main font-bold text-[15px] md:text-[16px] shadow-[0_12px_32px_-4px_rgba(196,154,69,0.1)] hover:bg-primary-hover disabled:opacity-60 transition-colors flex items-center justify-center cursor-pointer"
          >
