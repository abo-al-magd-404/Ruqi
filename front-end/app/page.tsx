    ...
    <>
      <section className="relative h-screen flex flex-col items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            منصة تعليمية عربية مخصصة لرعاية الموهبة العلمية وصقل الهوية اللغوية،
            <br />
        ...
        <div className="mx-auto max-w-6xl w-full grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          >
            ...
            <p className="text-text-muted leading-relaxed mb-6">
              ...
              <br />
              ساهم الأستاذ سمير في صياغة مناهج رُقِيّ وتصميم المنهجيات التعليمية
              المتميزة التي تنقل الطالب من التأسيس البسيط إلى مستويات الإتقان
              العالية والبلاغة الفصحى.
            </p>
